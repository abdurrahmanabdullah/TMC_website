    ...
    const fetchData = async () => {
      try {
        ...
        const responseTemplate = await fetch(
          `https://api.strapi.transworldbd.com/api/dynamic-pages/${slug}?populate=deep,10`
        );
        const responseHome = await fetch(
          "https://api.strapi.transworldbd.com/api/homes?populate=deep,10"
        );
        ...
        >
          ...
          <div style={{ flex: "1 1 50%", marginRight: "20px" }}>
            {image && (
              <div>
                <img
                  src={`https://api.strapi.transworldbd.com${image.data.attributes.url}`}
...
//         const responseTemplate = await fetch(`https://api.strapi.transworldbd.com/api/dynamic-pages/${slug}?populate=deep,10`);
//         const dataTemplate = await responseTemplate.json();
...
//         const responseHome = await fetch('https://api.strapi.transworldbd.com/api/homes?populate=deep,10');
//         const dataHome = await responseHome.json();
...
//             <img
//               key={image.id}
//               src={`https://api.strapi.transworldbd.com${image.attributes.url}`}

...
//           "https://api.strapi.transworldbd.com/api/contact-info?populate=deep,10"
//         );
...
//         const imageUrl = `
//         https://api.strapi.transworldbd.com${data.data.attributes.contact.image.data.attributes.url}`;
//         setImageData({
//           url: imageUrl,
...
//     try {
//       const response = await fetch(
//         "https://api.strapi.transworldbd.com/contacts",
//         {
//           method: "POST",
//           headers: {
...
import React, { useState, useEffect } from "react";
import styles from "../App.css";
import MagneticFramer from "../components/magneticFrame/magneticFrame";
const ContactForm = () => {
  const [formData, setFormData] = useState({
    name: "",
    email: "",
